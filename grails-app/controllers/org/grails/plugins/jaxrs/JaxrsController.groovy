...
import org.grails.plugins.jaxrs.web.RequestWrapper
...
class JaxrsController {
    ...
    def handle() {
        ...
        // servlet request.
        ServletResponse unwrapped = unwrap(response)

        // Let the JAX-RS implementation process the request
        jaxrsContext.jaxrsService.process(new RequestWrapper(request), unwrapped as HttpServletResponse)
